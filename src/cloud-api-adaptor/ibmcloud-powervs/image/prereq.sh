...
yum install -y curl libseccomp-devel openssl openssl-devel skopeo clang clang-devel perl iptables zstd
...
wget https://www.rpmfind.net/linux/centos-stream/10-stream/CRB/ppc64le/os/Packages/protobuf-compiler-3.19.6-10.el10.ppc64le.rpm
yum install -y protobuf-compiler-3.19.6-10.el10.ppc64le.rpm

wget https://rpmfind.net/linux/centos-stream/10-stream/CRB/ppc64le/os/Packages/device-mapper-devel-1.02.202-5.el10.ppc64le.rpm
yum install -y device-mapper-devel-1.02.202-5.el10.ppc64le.rpm
